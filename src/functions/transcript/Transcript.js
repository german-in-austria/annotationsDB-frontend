...
const localFunctions = {
  TranscriptBase (lPk, vueObj) {
    ...
    this.selectedEvent = null           // Aktuell ausgewählter Event
    ...
    this.selectedEventBereich = {'v': null, 'b': null}  // Aktuell ausgewählter Event Bereich
    this.selectedEventListe = []        // Liste der aktuell ausgewählten Events
    ...
    this.hoveredEventSet = null         // EventSet über dem der Mauszeiger ist
...
localFunctions.TranscriptBase.prototype.selectedEventBereichUpdate = prototypeTranscriptBase.selectedEventBereichUpdate
